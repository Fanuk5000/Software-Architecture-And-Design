from typing import Any, runtime_checkable, TYPE_CHECKING
...
class Team(ABC):
    ...
    name: str
    _players: list["IPlayer" | Any]

    @property
    @abstractmethod
    def players(self) -> list["IPlayer" | Any]: ...

    @players.setter
    @abstractmethod
    def players(self, value: list["IPlayer" | Any]) -> None: ...
...
class AliasTeam(Team):
    ...
    @players.setter
    def players(self, value: list["AliasPlayer" | Any]) -> None:
